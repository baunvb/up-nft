...
import { formatCurrency, getDetailCategory, _artIdToCategoryId, unit256ToNumber, getCategoryData, mintArtByCategoryId, formatShortWalletAddress, getBalanceOfConnectedWallet, getCategoryIdFromNftId } from '../../../utils/Util';
...
import AddressCopyable from '../../../component/address/AddressCopyable';
...
const MyNftDetail: React.FC<{ id: number }> = ({ id }) => {
    ...
    function requestSellNft() {
        ...
        >
            <div>
                <span className="detail-dialog-tx-header">This feature is currently not support</span>
            </div>
        </DialogComponent>)
    }
        ...
        <div className="detail">
            ...
            <div className="detail-content">
                ...
                <div className="detail-center">
                    ...
                    <NavLink
                        to={"/view?id=" + id + "&type=mycolection"}
                    >
                ...
                <div className="detail-right">
                    <div>
                        <span>
                            <span className="detail-highlight-label">Token Address</span>
                            <AddressCopyable
                                address={CONTRACTS_ADDRESS.UP_NFT}
                                className="detail-your-balance"
                                length={8}
                            />
                        </span>
                        <span>
                            <span className="detail-highlight-label">Token ID</span>
                            <span className="detail-your-balance">
                                <span>{id}</span>
                            </span>
