...
import { formatCurrency, getDetailCategory, _artIdToCategoryId, unit256ToNumber, getCategoryData, mintArtByCategoryId, formatShortWalletAddress, getBalanceOfConnectedWallet } from '../../../utils/Util';
...
const MarketplaceDetail: React.FC<{ id: number }> = ({ id }) => {
    ...
    function onTransactionHash(tx: string) {
        ...
        >
            <div className="center">
                <Loading />
                <span className="detail-dialog-tx-header">Transaction was submitted. Please wait...</span>
